...
namespace Common.Logging
{
    public class SyslogLoggerProvider : ILoggerProvider
    {
        ...
        { _host = host; _port = port; _filter = filter; }
    ...
    public class SyslogLogger : ILogger
    {
        ...
        public void Log<TState>(LogLevel logLevel, EventId eventId, TState state, Exception exception, Func<TState, Exception, string> formatter)
        {
            ...
            var syslogLevel = MapToSyslogLevel(logLevel); Send(syslogLevel, message);
        }
        ...
        private SyslogLogLevel MapToSyslogLevel(LogLevel level)
        {
            ...
            if (level == LogLevel.Error) return SyslogLogLevel.Error; if (level == LogLevel.Information)
    ...
    //public static class SyslogLoggerExtensions
    //{
    //    public static ILoggingBuilder AddSyslog(this ILoggingBuilder builder, string host, int port, Func<string, LogLevel, bool> filter = null)
    //    {
    //        builder.Services.AddSingleton<ILoggerProvider>(new SyslogLoggerProvider(host, port, filter));
    //        return builder;
    //    }
    //}
    //public static class SyslogLoggerExtensions
